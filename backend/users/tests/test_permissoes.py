...
class TestePermissoesRBAC:
    ...
    def test_aluno_tem_permissao_apenas_de_leitura(self):
    ...
    def test_professor_tem_permissao_total(self):
        req_leitura = self.fabrica.get('/fake-url/')
    ...
    def test_permissao_estrita_bloqueia_aluno_completamente(self):
        req_leitura = self.fabrica.get('/fake-url/')
        req_leitura.user = self.aluno
